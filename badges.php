...
<div class="container">
	<div class="row">
		<div class="col-md-12">
			<div class="box">
				<div class="titulo" style="color: white;background-image: url(./web/assets/images/header.png);background-position: center;"> <i class="fa fa-plus-square-o" style="font-weight: 300"></i> últimos emblemas <input type="button" onclick="baixar_badges();" style="margin-top: 7px;margin-right: 5px;float: right; width: 105px" class="btn btn-custom" value="Download"> </div>
				<div id="badges" style="padding: 5px">
					Carregando...
				</div>
			</div>
		</div>
...
$(document).ready(function(){
	...
	$('#badges').load('./includes/badges.php');
});

function baixar_badges(){
	var confirma = confirm("Tem certeza que deseja baixar todos os emblemas?");
		
	if(confirma == true) {
		window.location = "./library/zip_badges.php";
	} else {
		console.log('Failed!');
	}
}
